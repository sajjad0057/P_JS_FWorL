...
const PostInteraction = ({
	...
	const likeAction = async () => {
      ...
      console.log(`Error From PostInteraction.tsx -> likeAction : ${JSON.stringify(error)}`)
    }
	};
	...
	return (
		...
		<div className="flex items-center justify-between text-sm my-3">
			<div className="flex gap-8">
				<div className="flex items-center gap-4 bg-slate-50 p-2 rounded-xl hover:bg-slate-100">
